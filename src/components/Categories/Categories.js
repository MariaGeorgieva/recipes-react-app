...
export default function Categories() {
    ...
    return (
        ...
        <ul className={styles["container"]}>
            ...
            <li className={styles["category-li"]}>
                <Link to="category/cupcakes" className={styles["category-href"]}>
                    <img className={styles["category-svg"]} src={muffin} alt="Cupcakes" />
                    Cupcakes
                </Link>
            </li>

            <li className={styles["category-li"]}>
                <Link to="category/donuts" className={styles["category-href"]}>
            ...
            <li className={styles["category-li"]}>
                <Link to="category/macaroons" className={styles["category-href"]}>
            ...
            <li className={styles["category-li"]}>
                <Link to="category/croissants" className={styles["category-href"]}>
            ...
            <li className={styles["category-li"]}>
                <Link to="category/chocolate" className={styles["category-href"]}>
            ...
            <li className={styles["category-li"]}>
                <Link to="category/drinks" className={styles["category-href"]}>
            ...
            <li className={styles["category-li"]}>
                <Link to="category/romantic-dessert" className={styles["category-href"]}>
                    <img className={styles["category-svg"]} src={dishes} alt="Drinks" />
                    Romantic Dessert
                </Link>
            </li>
